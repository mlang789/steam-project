# genai/build_prompt_batch.py
"""
Create a batch of prompts for conditional Steam review generation.
...
The output file contains prompts for 2 methods:
- naive
- engineered

You can then paste prompts into ChatGPT manually and fill 'generated_text'.
"""
